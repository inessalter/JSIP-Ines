...
val second_snake : t -> Snake.t

(** [handle_key] will be called whenever the user presses a key. It takes
    that key and updates the game accordingly *)
